...
def main():
    ...
    cd ragcraft-by-mustafa-shoukat/rag_tutorials/rag-as-a-service
    ```
    ...
    - Sign up for Ragie and Anthropic accounts if you haven't already.
    ...
    6. Follow the on-screen instructions to upload documents and ask questions.

    For more detailed instructions, check the [GitHub repository](https://github.com/Mustafa-Shoukat1/ragcraft-by-mustafa-shoukat) and the [Ragie documentation](https://docs.ragie.ai/).